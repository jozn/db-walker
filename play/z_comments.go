...
) // (shortname .TableNameGo "err" "res" "sqlstr" "db" "XOLog") -}}//(schema .Schema .Table.TableName) -}}// .TableNameGo}}// Comments represents a row from 'os.comments'.
...
func (c *Comments) Insert(db XODB) error {
	...
	const sqlstr = `INSERT INTO os.comments (` +
...
func (c *Comments) Replace(db XODB) error {
	...
	const sqlstr = `REPLACE INTO os.comments (` +
		`UserId, PostId, Text, CreatedTime` +
		`) VALUES (` +
		`?, ?, ?, ?` +
		`)`
...
func (c *Comments) Update(db XODB) error {
	...
	// sql query
	const sqlstr = `UPDATE os.comments SET ` +
		`UserId = ?, PostId = ?, Text = ?, CreatedTime = ?` +
		` WHERE Id = ?`
...
func (c *Comments) Delete(db XODB) error {
	...
	// sql query
	const sqlstr = `DELETE FROM os.comments WHERE Id = ?`
...
func (u *__Comments_Selector) _stoSql() (string, []interface{}) {
	...
	sqlstr := "SELECT " + u.selectCol + " FROM os.comments"
...
func (u *__Comments_Updater) Update(db XODB) (int, error) {
	...
	sqlstr := `UPDATE os.comments SET ` + sqlUpdate
...
func (d *__Comments_Deleter) Delete(db XODB) (int, error) {
	...
	sqlstr := "DELETE FROM os.comments WHERE " + wheresStr
...
func MassInsert_Comments(rows []Comments, db XODB) error {
	...
	// sql query
	sqlstr := "INSERT INTO os.comments (" +
		"UserId, PostId, Text, CreatedTime" +
		") VALUES " + insVals
...
func MassReplace_Comments(rows []Comments, db XODB) error {
	...
	insVals := insVals_[0 : len(insVals_)-1]
	// sql query
	sqlstr := "REPLACE INTO os.comments (" +
		"UserId, PostId, Text, CreatedTime" +
		") VALUES " + insVals
