...
)// (shortname .TableNameGo "err" "res" "sqlstr" "db" "XOLog") -}}//(schema .Schema .Table.TableName) -}}// .TableNameGo}}// Chat represents a row from 'os.chat'.
...
func (c *Chat) Insert(db XODB) error {
	...
	const sqlstr = `INSERT INTO os.chat (` +
...
func (c *Chat) Replace(db XODB) error {
	...
	const sqlstr = `REPLACE INTO os.chat (` +
		`ChatKey, RoomKey, RoomTypeEnumId, UserId, PeerUserId, GroupId, CreatedSe, StartMessageIdFrom, LastSeenMessageId, UpdatedMs, LastMessageId, LastDeletedMessageId, LastSeqSeen, LastSeqDelete, CurrentSeq` +
		`) VALUES (` +
		`?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?` +
		`)`
...
func (c *Chat) Update(db XODB) error {
	...
	// sql query
	const sqlstr = `UPDATE os.chat SET ` +
...
func (c *Chat) Delete(db XODB) error {
	...
	// sql query
	const sqlstr = `DELETE FROM os.chat WHERE ChatKey = ?`
...
func (u *__Chat_Selector)_stoSql ()  (string,[]interface{}) {
	...
	sqlstr := "SELECT " +u.selectCol +" FROM os.chat"
...
func (u *__Chat_Updater)Update (db XODB) (int,error) {
    ...
    sqlstr := `UPDATE os.chat SET ` + sqlUpdate
...
func (d *__Chat_Deleter)Delete (db XODB) (int,error) {
    ...
    sqlstr := "DELETE FROM os.chat WHERE " + wheresStr
